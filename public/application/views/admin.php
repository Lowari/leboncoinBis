        ...
        <tbody>
          <?php foreach ($description_list as $user) { ?>
            <tr class="table-light">
              ...
              <td><?= $user->mail ?></td>
              <td>
                <form method="POST" action="deleteUser"><button class="btn btn-primary" type="submit" name="deleteId" id="deleteId" value="<?= $user->id ?>"><i class="fas fa-gavel"><u>Supprimer</u></i></button></form>
              </td>
            </tr>
          <?php } ?>
        </tbody>
